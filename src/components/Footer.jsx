        ...
        <div className={`${isDarkMode ? 'bg-gray-800/70' : 'bg-gray-700/70'} backdrop-blur-lg border ${isDarkMode ? 'border-gray-700/50' : 'border-gray-600/50'} rounded-2xl p-8 shadow-2xl transform transition-all duration-700 hover:shadow-2xl hover:shadow-teal-500/10`}>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="footer-item opacity-0 transform translate-y-10 transition-all duration-700">
              <h3 className="text-2xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-teal-300 to-cyan-300">Coderise</h3>
              <p className="text-gray-300 mb-6 leading-relaxed">
                Premier Coderise coaching center in Hyderabad with 98% success rate. Expert trainers, personalized attention, and proven results.
              </p>
            ...
            <div className="footer-item opacity-0 transform translate-y-10 transition-all duration-700">
              <h3 className="text-2xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-teal-300 to-cyan-300">Coderise Services</h3>
              <ul className="space-y-3">
            ...
            <div className="footer-item opacity-0 transform translate-y-10 transition-all duration-700">
              ...
              <ul className="space-y-4">
                <li className="flex items-start group">
                  ...
                  <span className="text-gray-300 group-hover:text-teal-300 transition-colors duration-300 pt-1.5">Adithya enclave 
First floor, Hastinapuram</span>
                </li>
                <li className="flex items-center group">
                  <div className="w-10 h-10 rounded-full bg-gray-700 flex items-center justify-center text-teal-400 mr-3 group-hover:bg-teal-500 group-hover:text-white transition-all duration-300">
                    <PhoneIcon className="h-5 w-5" />
                  </div>
                  <span className="text-gray-300 group-hover:text-teal-300 transition-colors duration-300">+91 9390933435</span>
                </li>
                <li className="flex items-center group">
                  <div className="w-10 h-10 rounded-full bg-gray-700 flex items-center justify-center text-teal-400 mr-3 group-hover:bg-teal-500 group-hover:text-white transition-all duration-300">
                    <EnvelopeIcon className="h-5 w-5" />
                  </div>
                  <span className="text-gray-300 group-hover:text-teal-300 transition-colors duration-300">info@Coderise.com</span>
                </li>
                <li className="flex items-center group">
                  <div className="w-10 h-10 rounded-full bg-gray-700 flex items-center justify-center text-teal-400 mr-3 group-hover:bg-teal-500 group-hover:text-white transition-all duration-300">
          ...
          <div className="mt-12 pt-8 border-t border-gray-700/50 text-center footer-item opacity-0 transform translate-y-10 transition-all duration-700">
            <p className="text-gray-400 text-sm mb-4">
              &copy; {new Date().getFullYear()} Coderise  Academy. All rights reserved.
            </p>
