                  ...
                  >
                    ...
                    <AnimatePresence>
                      {coursesOpen && (
                        ...
                        >
                          {[
                            { name: 'Coderise Academic', icon: '🎓', desc: 'University admissions' },
                            { name: 'Coderise General', icon: '🌍', desc: 'Immigration & work' },
                      ...
                      <div>
                        ...
                        <AnimatePresence>
                          {coursesOpen && (
                            ...
                            >
                              {[
                                { name: 'Coderise Academic', icon: '🎓' },
                                { name: 'Coderise General', icon: '🌍' },
