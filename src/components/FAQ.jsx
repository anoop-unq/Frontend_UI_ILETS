...
const FAQ = () => {
  ...
  const faqs = [
    {
      question: "What is the difference between Coderise Academic and General Training?",
      answer: "Coderise Academic is for students applying for higher education or professional registration, while Coderise General Training is for those migrating to English-speaking countries or applying for secondary education and work experience. The Reading and Writing sections differ between the two versions.",
      icon: <BookOpen className="h-5 w-5 sm:h-6 sm:w-6" />,
      category: "Test Types"
    },
    {
      question: "How long is the Coderise test valid?",
      answer: "Coderise results are valid for 2 years from the test date. After this period, organizations may not accept your scores as they consider your language proficiency might have changed.",
      icon: <Clock className="h-5 w-5 sm:h-6 sm:w-6" />,
      category: "Validity"
    },
    {
      question: "What is a good Coderise score?",
    ...
    {
      question: "How long does the Coderise test take?",
    ...
    {
      question: "Can I retake only one section of the Coderise?",
      answer: "Yes, Coderise now offers One Skill Retake for test takers to improve their score in a single section (Listening, Reading, Writing, or Speaking) without retaking the entire test. This must be done within 60 days of your original test.",
      icon: <Target className="h-5 w-5 sm:h-6 sm:w-6" />,
      category: "Retakes"
    },
    {
      question: "How is the Coderise Speaking test conducted?",
    ...
    {
      question: "When will I get my Coderise results?",
      answer: "Computer-delivered Coderise results are available in 3-5 days, while paper-based test results take 13 days. You'll receive a Test Report Form showing your scores for each section and overall band score.",
      icon: <Calendar className="h-5 w-5 sm:h-6 sm:w-6" />,
      category: "Results"
    },
    {
      question: "What's the difference between computer-delivered and paper-based Coderise?",
      ...
      <div className="max-w-8xl mx-auto relative z-10">
        ...
        >
          ...
          <p className={`text-base sm:text-lg md:text-xl lg:text-2xl max-w-6xl mx-auto leading-relaxed px-2 ${
            ...
            Comprehensive answers to all your Coderise queries from our team of certified experts with 15+ years of experience
          </p>
        </motion.div>
        ...
        >
          <div className={`rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 backdrop-blur-lg border ${
            ...
            <h3 className={`text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-4 sm:mb-6 ${
              ...
              Ready to Achieve Your <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Dream Coderise Score</span>?
            </h3>
            <p className={`text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl mb-6 sm:mb-8 max-w-4xl mx-auto leading-relaxed ${
              isDarkMode ? 'text-gray-300' : 'text-gray-600'
            }`}>
              Join our community of successful students and get personalized coaching from Coderise experts with proven results.
            </p>
