...
const Services = () => {
  ...
  const services = [
    {
      name: "Coderise Preparation",
      tagline: "Complete exam mastery",
      description: "Comprehensive Coderise exam preparation with proven strategies for academic success.",
    ...
    },
    {
      ...
      description: "Professional guidance and feedback to excel in Coderise writing tasks.",
    ...
    },
    {
      ...
      description: "Advanced listening exercises to master the Coderise listening section.",
    ...
    },
    {
      ...
      description: "Improve reading speed and comprehension for Coderise success.",
    ...
    },
    {
      ...
      description: "Access extensive Coderise study materials and digital resources.",
...
>
          ...
          <p className="text-xl md:text-2xl text-gray-200 mb-12 max-w-4xl mx-auto leading-relaxed">
            Comprehensive Coderise training programs with expert instructors, personalized coaching, and proven strategies for academic and career success.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-bold mb-6">
              Comprehensive <span className="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">Coderise Programs</span>
            </h2>
      ...
      <div className="relative py-24 overflow-hidden">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold mb-6">
            Start Your Coderise Journey Today
          </h2>
