...
const About = () => {
  ...
  const teamMembers = [
    {
      ...
      role: "Coderise Chief Examiner",
      bio: "With over 15 years of experience in English language assessment, Dr. Thompson specializes in Coderise test development and evaluation.",
    ...
    },
    {
      ...
      achievements: ["Coderise Author", "Global Workshop Trainer", "Band 9 Specialist"]
    },
    {
  ...
  const stats = [
    { id: 1, name: 'Years of Coderise Expertise', value: '50+', icon: ClockIcon, color: 'from-orange-500 to-red-500' },
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Exclusive study materials developed by former Coderise examiners",
      gradient: "from-yellow-500 to-amber-600"
    },
    {
      icon: CheckBadgeIcon,
      title: "Certified Trainers",
      description: "All our trainers are certified Coderise examiners with 10+ years experience",
          ...
          >
            <div className="lg:w-1/2">
              ...
              <p className="mt-6 text-xl lg:text-2xl text-blue-100 max-w-2xl">
                Transforming Coderise aspirations into exceptional results since 2010
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl sm:text-5xl font-bold mb-6">
                A Legacy of <span className="bg-gradient-to-r from-yellow-400 to-amber-400 bg-clip-text text-transparent">Coderise Excellence</span>
              </h2>
              <div className="space-y-6 text-lg">
                <p className="leading-relaxed">
                  Founded in 2010 by Dr. Sarah Thompson, Coderise Mastery began as a visionary coaching center dedicated to revolutionizing Coderise preparation through personalized, results-driven methodologies.
                </p>
                <p className="leading-relaxed">
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    >
      <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
        Meet Our Coderise Experts
      </h2>
      <p className={`text-lg sm:text-xl max-w-3xl mx-auto ${
        isDarkMode ? 'text-gray-300' : 'text-gray-600'
      }`}>
        Certified Coderise examiners and language specialists with proven track records
      </p>
    </motion.div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
      {[
        {
          name: "Sarah Johnson",
          role: "Senior Coderise Examiner",
          image: assets.Anvesh,
          bio: "Former Coderise examiner with 8+ years experience. Helped 1000+ students achieve band 8+ scores.",
          achievements: ["Band 9 Expert", "8+ Years Exp", "1000+ Students"],
          specialties: ["Writing Correction", "Speaking Mock Tests", "Band 9 Strategies"]
        },
        {
          name: "David Chen",
          role: "Coderise Speaking Specialist",
        ...
        },
        {
          ...
          bio: "Comprehensive Coderise training approach focusing on all four modules simultaneously.",
          achievements: ["Band 8+ Coach", "Overall Strategy", "Personalized Plans"],
          specialties: ["Full Test Prep", "Time Management", "Score Analysis"]
        },
        {
          name: "James Wilson",
          role: "Academic Coderise Specialist",
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of successful students who transformed their Coderise goals into reality with our expert guidance.
          </p>
