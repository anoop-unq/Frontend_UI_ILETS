  ...
  const contactInfo = [
    {
      ...
      content: '123 Education District, Academic City, AC 12345',
    ...
    },
    {
      ...
      subcontent: 'Registration: +1 (555) 123-4568'
    },
    {
      icon: '✉️',
      title: 'Email Addresses',
      content: 'General: info@ieltstestcenter.com',
      subcontent: 'Registration: registration@ieltstestcenter.com'
    },
    {
      icon: '🕒',
      title: 'Office Hours',
    ...
    },
    {
      ...
      content: 'Priority Support: +1 (555) 123-4569',
      ...
      <div className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            Start Your 
            <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent"> IELTS Journey</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
            Connect with certified IELTS experts for test registration, preparation guidance, and personalized support to achieve your target score.
          </p>
        </motion.div>
      </div>
              ...
              {submitSuccess ? (
                ...
                >
                  ...
                  <p className={`text-lg ${isDarkMode ? 'text-green-200' : 'text-green-700'}`}>
                    Thank you for your interest in IELTS. Our team will contact you within 12 hours.
                  </p>
                  <motion.button
                ...
                <>
                  <div className="text-center mb-8">
                    ...
                    <p className={`text-lg ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                      Complete the form below and our IELTS coordinators will contact you within 12 hours.
                    </p>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        placeholder="Tell us about your IELTS requirements, target score, and preferred test date..."
                      ></textarea>
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className={`text-xl max-w-2xl mx-auto ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
              Our IELTS test center is conveniently located in the city center with excellent transport links
            </p>
          </div>
          ...
          <div className={`rounded-3xl overflow-hidden shadow-2xl border-2 ${
            ...
            <iframe
              title="IELTS Test Center Location"
              width="100%"
              height="500"
              frameBorder="0"
              style={{ border: 0 }}
      ...
      <div className="relative bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16 overflow-hidden">
        ...
        >
          ...
          >
            ...
            Priority Support: +1 (555) 123-4569
          </motion.a>
        </motion.div>
      </div>
    </div>
