...
//       description: "Certified IELTS examiners with 10+ years experience"
//     },
//     {
...
//       name: "Anoop Anvesh",
//       score: "Band 9.5",
//       comment: "The personalized feedback helped me improve from 6.5 to 8.5 in writing!",
//       avatar: `${assets.Anvesh}`
//     },
//     {
//       name: "Raj Patel",
//       score: "Band 9.0",
//       comment: "Best IELTS coaching! The mock tests were exactly like the real exam.",
//       avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80"
//     },
//     {
//       name: "Anita Verma",
//       score: "Band 8.0",
//       comment: "Flexible timings and excellent study materials made my preparation smooth.",
...
//           <img
//             src="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=4000&q=80"
//             alt="IELTS Success"
...
//                 Master IELTS
//               </span>
//               <span className="block text-4xl md:text-6xl text-yellow-400 mt-4">Achieve Band 8.0+</span>
//             </h1>
            
//             <p className="text-xl md:text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed mb-12">
//               Join India's most trusted IELTS preparation platform with personalized coaching, 
...
//                 <Link
//                   to="/contact"
//                   className="flex items-center px-8 py-4 bg-yellow-500 hover:bg-yellow-600 text-white font-bold rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 text-lg"
//                 >
...
//                   className="flex items-center px-8 py-4 bg-white/20 hover:bg-white/30 text-white font-bold rounded-2xl backdrop-blur-sm border border-white/30 transition-all duration-300 text-lg"
//                 >
...
//      <section id="testimonials" className="py-20 bg-gradient-to-br from-blue-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900/20">
...
//     >
//       <div className="inline-flex items-center bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-300 px-4 py-2 rounded-full text-sm font-medium mb-6">
...
//         </span>
//         <br />
//         <span className="text-2xl md:text-3xl text-gray-600 dark:text-gray-300">Stories That Inspire</span>
//       </h2>
      
//       <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-4xl mx-auto leading-relaxed">
//         Discover how our students transformed their IELTS dreams into remarkable achievements with personalized coaching and proven strategies
//       </p>
//     </motion.div>
...
//           avatar: "https://tse4.mm.bing.net/th/id/OIP.OE6i-QcSXFrTfU1eEqcqIAHaE7?pid=Api&P=0&h=180",
...
//           avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=400&q=80",
//           course: "IELTS Academic",
//           duration: "10 Weeks",
...
//           avatar: "https://images.unsplash.com/photo-1554151228-14d9def656e4?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=400&q=80",
//           course: "IELTS Academic", 
//           duration: "9 Weeks",
...
//           avatar: "https://images.unsplash.com/photo-1552058544-f2b08422138a?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=400&q=80",
//           course: "IELTS General",
//           duration: "5 Weeks",
...
//       whileInView={{ opacity: 1, y: 0 }}
//       viewport={{ once: true }}
//       className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 md:p-12 text-white text-center mb-16 shadow-2xl"
//     >
//       <h3 className="text-2xl md:text-3xl font-bold mb-8">Our IELTS Success Metrics</h3>
...
//             Join thousands of students who achieved their dream IELTS scores with our proven methodology
//           </p>
...
//               whileTap={{ scale: 0.95 }}
//               className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold transition-colors duration-300 flex items-center justify-center"
//             >
...
//               whileHover={{ scale: 1.05 }}
//               whileTap={{ scale: 0.95 }}
//               className="border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 px-8 py-3 rounded-lg font-semibold transition-colors duration-300 flex items-center justify-center"
//             >
...
//       {/* Stats Bar */}
//       <section className={`py-12 ${isDarkMode ? 'bg-gray-800' : 'bg-white'} shadow-xl`}>
...
//             ].map((stat, index) => (
//               <div key={index} className="text-center">
//                 <div className={`text-3xl font-bold ${isDarkMode ? 'text-yellow-400' : 'text-blue-600'}`}>
//                   {stat.number}
//                 </div>
...
//               Comprehensive preparation designed by former IELTS examiners
//             </p>
//           </motion.div>
...
//                   {service.description}
//                 </p>
//                 <button className="mt-6 flex items-center text-white font-semibold hover:text-yellow-300 transition-colors">
//                   Learn More
...
//                 <Link
//                   to="/contact"
//                   className="flex items-center px-8 py-4 bg-yellow-500 hover:bg-yellow-600 text-white font-bold rounded-2xl shadow-2xl text-lg transition-all duration-300"
//                 >
//                   <Calendar className="h-5 w-5 mr-3" />
//                   Book Free Demo Class
//                 </Link>
...
//                   className="flex items-center px-8 py-4 bg-white/20 hover:bg-white/30 text-white font-bold rounded-2xl backdrop-blur-sm border border-white/30 text-lg transition-all duration-300"
//                 >
...
//             <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 text-blue-200">
    ...
    <div className={`min-h-screen ${isDarkMode ? 'bg-gradient-to-br from-gray-900 via-blue-900/20 to-gray-800' : 'bg-gradient-to-br from-blue-50 via-white to-gray-100'}`}>
      ...
      <section id="testimonials" className="py-16 sm:py-20 bg-gradient-to-br from-blue-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-6 sm:mb-8">Our IELTS Success Metrics</h3>
